...
import 'package:way/app/pages/buisness_screens/auth/signup/buisness_signup_screen.dart';
import 'package:way/app/pages/buisness_screens/buisness_home.dart';
  ...
  loginTapped() {
    ...
    if (formkey.currentState!.validate()) {
      ...
      Navigator.of(context).pushReplacement(
          MaterialPageRoute(builder: (context) => const BuisnessHome()));
